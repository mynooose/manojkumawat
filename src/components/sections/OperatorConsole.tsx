...
export function OperatorConsole() {
  ...
  return (
    <Section id="console">
      ...
      <Reveal className="rounded-container border border-line bg-surface-2 p-[clamp(16px,2.2vw,26px)]">
        {/* Controls */}
        ...
        {isReady ? (
          <>
            <div className="mb-5 grid grid-cols-2 gap-3 min-[1000px]:grid-cols-4">
              {data.kpis.map((kpi) => (
                <div key={kpi.k} className="rounded-inner border border-line bg-surface p-[14px]">
                ...
                >
                  <defs>
                    <linearGradient id="areaFill" x1="0" y1="0" x2="0" y2="1">
                      ...
                      <stop offset="100%" stopColor="#FF5C2B" stopOpacity="0" />
                    </linearGradient>
                  </defs>
